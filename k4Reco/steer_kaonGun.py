...
read.Files = ["/data/sim/kaonGun_pT_0_50/kaonGun_pT_0_50_sim_0.slcio"]
#read.Files = ["nuGun_v1.slcio"]
algList.append(read)
...
Output_REC.Parameters = {
    ...
    "LCIOOutputFile": ["kaonGun_reco_v0A.slcio"],
...
#    "DD4hepXMLFile": ["/code/detector-simulation/geometries/MuColl_v1/MuColl_v1.xml"],
...
#    "TrackerHitCollectionNames": ["VBTrackerHits", "IBTrackerHits", "OBTrackerHits"]
}
...
#    "ThresholdsFilePath": ["/opt/MyBIBUtils/share/MyBIBUtils/data/HCAL_Thresholds.root"],
    "ThresholdsFilePath": ["/code/CaloSelector/HCAL_Thresholds_10TeV.root"],
    "Nsigma": ["5"]
}
...
OverlayIP.Parameters = {
    ...
    #"BackgroundFileNames": ["/data/IPairs/sim_pairs_file1.slcio", "/data/IPairs/sim_pairs_file2.slcio", "/data/IPairs/sim_pairs_file3.slcio", "/data/IPairs/sim_pairs_file4.slcio"],
    "BackgroundFileNames": ["sim_pairs_6T.slcio"],
    "Collection_IntegrationTimes": [
        "VertexBarrelCollection", "-0.5", "15.",
        "VertexEndcapCollection", "-0.5", "15.",
        "InnerTrackerBarrelCollection", "-0.5", "15.",
